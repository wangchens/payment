...
abstract class Alipay implements GatewayInterface
{
    ...
    public function __construct(array $config)
    {
        ...
        $this->config = [
            ...
            'format'      => 'JSON',
            'charset'     => 'utf-8',
            'sign_type'   => $this->user_config->get('sign_type', 'RSA2'),
            'version'     => '1.0',
    ...
    public function pay(array $config_biz)
    {
        ...
        if (isset($config_biz['notify_url'])) {
            $this->config['notify_url'] = $config_biz['notify_url'];
        }
        if (isset($config_biz['return_url'])) {
            $this->config['return_url'] = $config_biz['return_url'];
        }
